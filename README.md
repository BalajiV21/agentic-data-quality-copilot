...
![Airflow](https://img.shields.io/badge/Airflow-orchestration-017CEE?style=flat-square)
![PySpark](https://img.shields.io/badge/PySpark-ETL-E25A1C?style=flat-square)
...
1. Pulls products, users, and orders from an API into raw JSON
2. Transforms and normalizes the raw data into a clean Bronze layer using PySpark
3. Passes the ETL logs to a GPT-4o-mini agent that reads them and reasons about data quality
4. Sends an email alert with a plain-English summary if anything looks wrong
...
Built by [Balaji Viswanathan](https://github.com/BalajiV21)
